...
import { DEFAULT_GROK_SEARCH_MODEL, selectXaiModel, type XaiModelMode } from "./xai-model-selection.js";
...
export class XaiAiSdkRuntime {
  ...
  model(params?: { model?: string; mode?: XaiModelMode }): LanguageModel {
...
export function buildXaiProviderOptions(params: {
  ...
  if (params.mode === "responses" && params.previousResponseId?.trim()) {
