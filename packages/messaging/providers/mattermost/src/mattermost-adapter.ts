  ...
  private async handleInteractiveCallback(
    ...
    const channelRef: MessagingChannelRef = {
      ...
      conversation: {
        ...
        ...(contextRootId ? { parentConversationId: body.channel_id } : {}),
        ...(body.team_id ? { workspaceId: body.team_id } : {}),
  ...
  private async handleSlashCommand(
      ...
      this.emitInboundRejected({
        ...
        channel: {
          ...
          conversation: {
            ...
            ...(body.root_id ? { parentConversationId: body.channel_id } : {}),
            ...(body.team_id ? { workspaceId: body.team_id } : {}),
            ...(body.channel_name ? { title: body.channel_name } : {}),
          },
        },
    ...
    const channelRef: MessagingChannelRef = {
      ...
      conversation: {
        ...
        ...(isThread ? { parentConversationId: body.channel_id } : {}),
        ...(body.team_id ? { workspaceId: body.team_id } : {}),
        ...(title ? { title } : {}),
