...
describe("tildifyPath", () => {
  it("collapses a home-prefixed path to ~", () => {
    expect(
      tildifyPath("/Users/huntharo/pwrdrvr/PwrAgnt", "/Users/huntharo"),
    ).toBe("~/pwrdrvr/PwrAgnt");
  });
  ...
  it("tolerates a trailing separator on the home directory", () => {
    expect(tildifyPath("/Users/huntharo/dev", "/Users/huntharo/")).toBe(
      "~/dev",
    );
  });

  it("leaves paths outside home unchanged", () => {
    expect(tildifyPath("/opt/work/app", "/Users/huntharo")).toBe(
      "/opt/work/app",
    );
  });
  ...
  it("returns the path unchanged when the home directory is unknown", () => {
    expect(tildifyPath("/Users/huntharo/app", undefined)).toBe(
      "/Users/huntharo/app",
    );
