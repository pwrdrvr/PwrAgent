...
describe("runtime identity formatting", () => {
  ...
  it("ignores the desktop app package when showing the runtime workspace", () => {
    expect(
      formatRuntimePath("/Users/huntharo/github/PwrAgent/apps/desktop"),
    ).toBe("github/PwrAgent");
  });
  ...
  it("shows the codex worktree id and repo for codex-managed worktrees", () => {
    expect(
      formatRuntimePath("/Users/huntharo/.codex/worktrees/5d4b/PwrAgent"),
    ).toBe("5d4b/PwrAgent");
  });
  ...
  it("ignores the desktop app package below a codex-managed worktree", () => {
    expect(
      formatRuntimePath(
        "/Users/huntharo/.codex/worktrees/5d4b/PwrAgent/apps/desktop",
      ),
    ).toBe("5d4b/PwrAgent");
  });
