...
export const ACP_AGENTS_GEMINI_CLI_PATH_ENV =
  "PWRAGENT_ACP_AGENTS_GEMINI_CLI_PATH";
export const ACP_AGENTS_GROK_CLI_PATH_ENV =
  "PWRAGENT_ACP_AGENTS_GROK_CLI_PATH";
export const ACP_AGENTS_KIMI_CLI_PATH_ENV =
  "PWRAGENT_ACP_AGENTS_KIMI_CLI_PATH";
export const ACP_AGENTS_QWEN_CLI_PATH_ENV =
  "PWRAGENT_ACP_AGENTS_QWEN_CLI_PATH";
...
export const GLAB_COMMAND_ENV = "PWRAGENT_GLAB_COMMAND";
export const GLAB_ENABLED_ENV = "PWRAGENT_GLAB_ENABLED";
export const GLAB_HOST_ENV = "PWRAGENT_GLAB_HOST";
export const GH_COMMAND_ENV = "PWRAGENT_GH_COMMAND";
export const GH_ENABLED_ENV = "PWRAGENT_GH_ENABLED";
