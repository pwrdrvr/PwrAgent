      ...
      return {
        ...
        properties: {
          ...
          cwdAccessConfirmed: {
            type: "boolean",
            description:
              "Set true only after the operator explicitly confirmed that this exact cwd may be added to the Default Access write scope. Not needed for Full Access or already-linked directories.",
          },
          messagingAttachment: {
            type: "string",
...
function normalizeHandoffTaskArgs(
  ...
  return {
    ...
    ...(args.cwdAccessConfirmed === true ? { cwdAccessConfirmed: true } : {}),
    ...(readChoice(
